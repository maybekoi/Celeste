...
namespace FMOD.Studio
{
    public class System : HandleBase
    {
        public static RESULT create(out FMOD.Studio.System studiosystem)
        {
            ...
            RESULT result = FMOD.Studio.System.FMOD_Studio_System_Create(out studiosystem1, 69652U);
            if (result != RESULT.OK)
                return result;
        ...
        public RESULT release() => FMOD.Studio.System.FMOD_Studio_System_Release(this.rawPtr);

        public RESULT update() => FMOD.Studio.System.FMOD_Studio_System_Update(this.rawPtr);
        ...
        public RESULT lookupID(string path, out Guid guid) => FMOD.Studio.System.FMOD_Studio_System_LookupID(this.rawPtr, Encoding.UTF8.GetBytes(path + "\0"), out guid);
        ...
        public RESULT getNumListeners(out int numlisteners) => FMOD.Studio.System.FMOD_Studio_System_GetNumListeners(this.rawPtr, out numlisteners);

        public RESULT setNumListeners(int numlisteners) => FMOD.Studio.System.FMOD_Studio_System_SetNumListeners(this.rawPtr, numlisteners);

        public RESULT getListenerAttributes(int listener, out _3D_ATTRIBUTES attributes) => FMOD.Studio.System.FMOD_Studio_System_GetListenerAttributes(this.rawPtr, listener, out attributes);

        public RESULT setListenerAttributes(int listener, _3D_ATTRIBUTES attributes) => FMOD.Studio.System.FMOD_Studio_System_SetListenerAttributes(this.rawPtr, listener, ref attributes);

        public RESULT getListenerWeight(int listener, out float weight) => FMOD.Studio.System.FMOD_Studio_System_GetListenerWeight(this.rawPtr, listener, out weight);

        public RESULT setListenerWeight(int listener, float weight) => FMOD.Studio.System.FMOD_Studio_System_SetListenerWeight(this.rawPtr, listener, weight);
        ...
        public RESULT unloadAll() => FMOD.Studio.System.FMOD_Studio_System_UnloadAll(this.rawPtr);

        public RESULT flushCommands() => FMOD.Studio.System.FMOD_Studio_System_FlushCommands(this.rawPtr);

        public RESULT flushSampleLoading() => FMOD.Studio.System.FMOD_Studio_System_FlushSampleLoading(this.rawPtr);

        public RESULT startCommandCapture(string path, COMMANDCAPTURE_FLAGS flags) => FMOD.Studio.System.FMOD_Studio_System_StartCommandCapture(this.rawPtr, Encoding.UTF8.GetBytes(path + "\0"), flags);

        public RESULT stopCommandCapture() => FMOD.Studio.System.FMOD_Studio_System_StopCommandCapture(this.rawPtr);
        ...
        public RESULT getBankCount(out int count) => FMOD.Studio.System.FMOD_Studio_System_GetBankCount(this.rawPtr, out count);
        ...
        public RESULT getCPUUsage(out CPU_USAGE usage) => FMOD.Studio.System.FMOD_Studio_System_GetCPUUsage(this.rawPtr, out usage);

        public RESULT getBufferUsage(out BUFFER_USAGE usage) => FMOD.Studio.System.FMOD_Studio_System_GetBufferUsage(this.rawPtr, out usage);

        public RESULT resetBufferUsage() => FMOD.Studio.System.FMOD_Studio_System_ResetBufferUsage(this.rawPtr);

        public RESULT setCallback(SYSTEM_CALLBACK callback, SYSTEM_CALLBACK_TYPE callbackmask = SYSTEM_CALLBACK_TYPE.ALL) => FMOD.Studio.System.FMOD_Studio_System_SetCallback(this.rawPtr, callback, callbackmask);

        public RESULT getUserData(out IntPtr userdata) => FMOD.Studio.System.FMOD_Studio_System_GetUserData(this.rawPtr, out userdata);

        public RESULT setUserData(IntPtr userdata) => FMOD.Studio.System.FMOD_Studio_System_SetUserData(this.rawPtr, userdata);
        ...
        protected override bool isValidInternal() => FMOD.Studio.System.FMOD_Studio_System_IsValid(this.rawPtr);
    }
}
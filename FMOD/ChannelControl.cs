...
public class ChannelControl : HandleBase
{
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetAudibility(
    IntPtr channelgroup,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetReverbProperties(
    IntPtr channelgroup,
    int instance,
    float wet);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetReverbProperties(
    IntPtr channelgroup,
    int instance,
    out float wet);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetCallback(
    IntPtr channelgroup,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetMixLevelsOutput(
    IntPtr channelgroup,
    float frontleft,
    float frontright,
    float center,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetMixLevelsInput(
    IntPtr channelgroup,
    float[] levels,
    int numlevels);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetMixMatrix(
    IntPtr channelgroup,
    float[] matrix,
    int outchannels,
    int inchannels,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetMixMatrix(
    IntPtr channelgroup,
    float[] matrix,
    out int outchannels,
    out int inchannels,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetDSPClock(
    IntPtr channelgroup,
    out ulong dspclock,
    out ulong parentclock);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetDelay(
    IntPtr channelgroup,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetDelay(
    IntPtr channelgroup,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_AddFadePoint(
    IntPtr channelgroup,
    ulong dspclock,
    float volume);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetFadePointRamp(
    IntPtr channelgroup,
    ulong dspclock,
    float volume);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_RemoveFadePoints(
    IntPtr channelgroup,
    ulong dspclock_start,
    ulong dspclock_end);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetFadePoints(
    IntPtr channelgroup,
    ref uint numpoints,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DAttributes(
    IntPtr channelgroup,
    ref VECTOR pos,
    ref VECTOR vel,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DAttributes(
    IntPtr channelgroup,
    out VECTOR pos,
    out VECTOR vel,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DMinMaxDistance(
    IntPtr channelgroup,
    float mindistance,
    float maxdistance);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DMinMaxDistance(
    IntPtr channelgroup,
    out float mindistance,
    out float maxdistance);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DConeSettings(
    IntPtr channelgroup,
    float insideconeangle,
    float outsideconeangle,
    float outsidevolume);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DConeSettings(
    IntPtr channelgroup,
    out float insideconeangle,
    out float outsideconeangle,
    out float outsidevolume);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DConeOrientation(
    IntPtr channelgroup,
    ref VECTOR orientation);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DConeOrientation(
    IntPtr channelgroup,
    out VECTOR orientation);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DCustomRolloff(
    IntPtr channelgroup,
    ref VECTOR points,
    int numpoints);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DCustomRolloff(
    IntPtr channelgroup,
    out IntPtr points,
    out int numpoints);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DOcclusion(
    IntPtr channelgroup,
    float directocclusion,
    float reverbocclusion);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DOcclusion(
    IntPtr channelgroup,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DDopplerLevel(
    IntPtr channelgroup,
    out float level);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Set3DDistanceFilter(
    IntPtr channelgroup,
    bool custom,
    float customLevel,
    float centerFreq);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_Get3DDistanceFilter(
    IntPtr channelgroup,
    out bool custom,
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetSystemObject(
    IntPtr channelgroup,
    out IntPtr system);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetDSP(
    IntPtr channelgroup,
    int index,
    out IntPtr dsp);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_SetDSPIndex(
    IntPtr channelgroup,
    IntPtr dsp,
    int index);

  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetDSPIndex(
    IntPtr channelgroup,
    IntPtr dsp,
    out int index);
  ...
  [DllImport("fmod")]
  private static extern RESULT FMOD_ChannelGroup_GetUserData(
    IntPtr channelgroup,
    out IntPtr userdata);

...
namespace FMOD
{
    ...
    public class DSP(IntPtr raw) : HandleBase(raw)
    {
      ...
      {
        return DSP.FMOD_DSP_DisconnectFrom(this.rawPtr, target.getRaw(), (HandleBase) connection != (HandleBase) null ? connection.getRaw() : IntPtr.Zero);
      }
      ...
      {
        IntPtr num = Marshal.AllocHGlobal(32 /*0x20*/);

...
public class LockBlock : Solid
{
  ...
  public void Appear()
  {
    ...
    this.Add((Component) Alarm.Create(Alarm.AlarmMode.Oneshot, (Action) (() =>
    {
      ...
      {
        scene.Particles.Emit(LockBlock.P_Appear, 16 /*0x10*/, this.Position + new Vector2(3f, 16f), new Vector2(2f, 10f), 3.14159274f);
        scene.Particles.Emit(LockBlock.P_Appear, 16 /*0x10*/, this.Position + new Vector2(29f, 16f), new Vector2(2f, 10f), 0.0f);
      }
      scene.Shake();
    }), 0.25f, true));
  }

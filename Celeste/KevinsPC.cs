...
public class KevinsPC : Actor
{
    ...
    : base(position)
  {
    ...
    this.subtex = this.spectogram.GetSubtexture(0, 0, 32 /*0x20*/, 18, this.subtex);
  ...
  {
    return this.Scene.CollideCheck(new Rectangle((int) this.X - 4, (int) this.Y, 8, 2), (Entity) solid);
  }
  ...
  public override void Update()
  {
    ...
    int num = this.spectogram.Width - 32 /*0x20*/;
    this.subtex = this.spectogram.GetSubtexture((int) ((double) this.timer * ((double) num / 22.0) % (double) num), 0, 32 /*0x20*/, 18, this.subtex);
  }

...
public class Celeste : Engine
{
  ...
  protected override void LoadContent()
  {
    ...
    Celeste.Celeste.LoadTimer = Stopwatch.StartNew();
    PlaybackData.Load();
    if (this.firstLoad)
    {
      this.firstLoad = false;
      Celeste.Celeste.HudTarget = VirtualContent.CreateRenderTarget("hud-target", 1922, 1082);
      Celeste.Celeste.WipeTarget = VirtualContent.CreateRenderTarget("wipe-target", 1922, 1082);
      OVR.Load();
      GFX.Load();
      MTN.Load();
    }
  ...
  public static bool IsMainThread => Thread.CurrentThread.ManagedThreadId == Celeste.Celeste._mainThreadId;

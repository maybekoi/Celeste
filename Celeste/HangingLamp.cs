...
public class HangingLamp : Entity
{
  ...
  public HangingLamp(Vector2 position, int length)
  {
    ...
    this.Length = Math.Max(16 /*0x10*/, length);
    this.Depth = 2000;
    ...
    this.Add((Component) (image2 = new Monocle.Image(mtexture.GetSubtexture(0, 16 /*0x10*/, 8, 8))));
    image2.Origin.X = 4f;
    ...
    this.Add((Component) (this.light = new VertexLight(Vector2.UnitY * (float) (this.Length - 4), Color.White, 1f, 24, 48 /*0x30*/)));
  ...
  public HangingLamp(EntityData e, Vector2 position)
    : this(position, Math.Max(16 /*0x10*/, e.Height))
  {
  }

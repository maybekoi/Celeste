...
namespace Celeste
{
    ...
    public class Cassette : Entity
    {
      ...
      public override void Added(Scene scene)
      {
        ...
        this.Add((Component) (this.light = new VertexLight(Color.White, 0.4f, 32 /*0x20*/, 64 /*0x40*/)));
      ...
      private IEnumerator CollectRoutine(Player player)
      {
        ...
        Vector2 camTo = (cassette.Position - new Vector2(160f, 90f)).Clamp((float) (level.Bounds.Left - 64 /*0x40*/), (float) (level.Bounds.Top - 32 /*0x20*/), (float) (level.Bounds.Right + 64 /*0x40*/ - 320), (float) (level.Bounds.Bottom + 32 /*0x20*/ - 180));

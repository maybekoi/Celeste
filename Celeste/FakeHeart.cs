...
public class FakeHeart : Entity
{
  ...
  public FakeHeart(Vector2 position)
    : base(position)
  {
    this.Add((Component) (this.crystalCollider = new HoldableCollider(new Action<Holdable>(this.OnHoldable))));
  ...
  public override void Awake(Scene scene)
  {
    ...
    this.Add((Component) (this.light = new VertexLight(Color.Lerp(color, Color.White, 0.5f), 1f, 32 /*0x20*/, 64 /*0x40*/)));

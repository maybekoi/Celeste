...
public class WaveDashPage02 : WaveDashPage
{
  ...
  public override IEnumerator Routine()
  {
    ...
    waveDashPage02.list = FancyText.Parse(Dialog.Get("WAVEDASH_PAGE2_LIST"), waveDashPage02.Width, 32 /*0x20*/, defaultColor: new Color?(Color.Black * 0.7f));
    float delay = 0.0f;
  ...
  public override void Render()
  {
    ...
    Matrix transformMatrix = Matrix.CreateRotationZ((float) ((double) Ease.CubeIn(1f - this.impossibleEase) * 8.0 - 0.5)) * Matrix.CreateTranslation((float) (this.Width - 500), (float) (this.Height - 600), 0.0f);
    Draw.SpriteBatch.End();
    Draw.SpriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearClamp, (DepthStencilState) null, (RasterizerState) null, (Effect) null, transformMatrix);

...
public class LightOcclude : Component
{
  ...
  public int Left
  {
    get
    {
      return this.bounds.HasValue ? (int) this.Entity.X + this.bounds.Value.Left : (int) this.Entity.Collider.AbsoluteLeft;
    }
  }

  public int Width
  {
    get => this.bounds.HasValue ? this.bounds.Value.Width : (int) this.Entity.Collider.Width;
  }
  ...
  public int Top
  {
    get
    {
      return this.bounds.HasValue ? (int) this.Entity.Y + this.bounds.Value.Top : (int) this.Entity.Collider.AbsoluteTop;
    }
  }

  public int Height
  {
    get => this.bounds.HasValue ? this.bounds.Value.Height : (int) this.Entity.Collider.Height;
  }

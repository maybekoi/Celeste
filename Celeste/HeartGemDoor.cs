...
namespace Celeste
{
    ...
    public class HeartGemDoor : Entity
    {
      ...
      {
        get => SaveData.Instance.CheatMode ? this.Requires : SaveData.Instance.TotalHeartGems;
      }
      ...
      public override void Added(Scene scene)
      {
        ...
        double y1 = (double) (bounds.Top - 32 /*0x20*/);
        ...
        this.TopSolid.SurfaceSoundIndex = 32 /*0x20*/;
        ...
        this.BotSolid.SurfaceSoundIndex = 32 /*0x20*/;

...
public class SpeedRing : Entity
{
  ...
  public override void Render()
  {
    ...
    if (color.A <= (byte) 0)
      return;
    Draw.SpriteBatch.Draw((Texture2D) (RenderTarget2D) GameplayBuffers.SpeedRings, this.Position + new Vector2(-32f, -32f), new Rectangle?(new Rectangle(this.index % 4 * 64 /*0x40*/, this.index / 4 * 64 /*0x40*/, 64 /*0x40*/, 64 /*0x40*/)), color);
  }
  ...
  public static void DrawToBuffer(Level level)
  {
    ...
    {
      speedRing.index = num;
      speedRing.DrawRing(new Vector2((float) (num % 4 * 64 /*0x40*/ + 32 /*0x20*/), (float) (num / 4 * 64 /*0x40*/ + 32 /*0x20*/)));
      ++num;
    }

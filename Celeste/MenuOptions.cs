...
public static class MenuOptions
{
  ...
  {
    menu.Add((TextMenu.Item) new TextMenu.Slider(Dialog.Clean("options_rumble_PC"), (Func<int, string>) (i =>
    {
      if (i == 2)
        return Dialog.Clean("OPTIONS_RUMBLE_ON");
      return i == 1 ? Dialog.Clean("OPTIONS_RUMBLE_HALF") : Dialog.Clean("OPTIONS_RUMBLE_OFF");
  ...
  {
    menu.Add((TextMenu.Item) new TextMenu.Slider(Dialog.Clean("OPTIONS_GRAB_MODE"), (Func<int, string>) (i =>
    {
      if (i == 0)

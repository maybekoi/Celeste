...
public class SummitCheckpoint : Entity
{
  ...
  public override void Render()
  {
    ...
    mtextureList[(int) this.numberString[0] - 48 /*0x30*/].DrawJustified(this.Position + new Vector2(-1f, 1f), new Vector2(1f, 0.0f));
    mtextureList[(int) this.numberString[1] - 48 /*0x30*/].DrawJustified(this.Position + new Vector2(0.0f, 1f), new Vector2(0.0f, 0.0f));
  }

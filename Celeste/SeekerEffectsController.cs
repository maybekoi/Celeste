...
public class SeekerEffectsController : Entity
{
  ...
  public SeekerEffectsController() => this.Tag = (int) Tags.Global;
  ...
  public override void Update()
  {
    ...
    if (this.enabled)
    {
      ...
      if (entity1 != null && !entity1.Dead)
      {
        ...
        target = (double) num3 < 0.0 ? 1f : Calc.ClampedMap(num3, 256f, 4096f, 0.5f);
        Distort.AnxietyOrigin = new Vector2((float) (((double) entity1.Center.X - (double) position.X) / 320.0), (float) (((double) entity1.Center.Y - (double) position.Y) / 180.0));

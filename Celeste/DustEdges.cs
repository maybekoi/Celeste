...
public class DustEdges : Entity
{
  ...
  {
    this.DustNoiseFrom = VirtualContent.CreateTexture("dust-noise-a", 128 /*0x80*/, 72, Color.White);
    this.DustNoiseTo = VirtualContent.CreateTexture("dust-noise-b", 128 /*0x80*/, 72, Color.White);

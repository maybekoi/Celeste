...
public class Player : Actor
{
  ...
  public const int StBirdDashTutorial = 16 /*0x10*/;
    ...
    : base(new Vector2((float) (int) position.X, (float) (int) position.Y))
  {
    ...
    this.StateMachine.SetCallbacks(16 /*0x10*/, new Func<int>(this.BirdDashTutorialUpdate), new Func<IEnumerator>(this.BirdDashTutorialCoroutine), new Action(this.BirdDashTutorialBegin));
    ...
    this.Add((Component) (this.Light = new VertexLight(this.normalLightOffset, Color.White, 1f, 32 /*0x20*/, 64 /*0x40*/)));
  ...
  {
    this.level.Particles.Emit(Player.P_Split, 16 /*0x10*/, this.Center, Vector2.One * 6f);
  }
  ...
  public Vector2 CameraTarget
  {
    get
    {
      ...
      {
        vector2.X += (float) (48 /*0x30*/ * Math.Sign(this.Speed.X));
        vector2.Y += (float) (48 /*0x30*/ * Math.Sign(this.Speed.Y));
      }
      else if (this.StateMachine.State == 10)
        vector2.Y -= 64f;
  ...
  public PlayerInventory Inventory
  {
    get
    {
      return this.level != null && this.level.Session != null ? this.level.Session.Inventory : PlayerInventory.Default;
    }
  }
  ...
  public int MaxDashes
  {
    get
    {
      return SaveData.Instance.Assists.DashMode != Assists.DashModes.Normal && !this.level.InCutscene ? 2 : this.Inventory.Dashes;
    }
  }
  ...
  {
    return this.StateMachine.State != 9 && this.StateMachine.State != 1 && (double) this.Speed.Y >= 0.0 && base.IsRiding(jumpThru);
  }
  ...
  {
    get => (double) this.wallBoostTimer > 0.0 ? this.Stamina + 27.5f : this.Stamina;
  }
  ...
  private bool SuperWallJumpAngleCheck
  {
    get
    {
      return (double) Math.Abs(this.DashDir.X) <= 0.20000000298023224 && (double) this.DashDir.Y <= -0.75;
    }
  }
  ...
  {
    get => this.StateMachine.State == 22 && this.ExactPosition == this.attractTo;
  }
  ...
  private int TempleFallUpdate()
  {
    ...
    if (!this.onGround)
    {
      int num = this.level.Bounds.Left + 160 /*0xA0*/;
  ...
  public IEnumerator IntroWalkCoroutine()
  {
    ...
    {
      player.X = (float) (player.level.Bounds.Left - 16 /*0x10*/);
      player.Facing = Facings.Right;
    }
    else
    {
      player.X = (float) (player.level.Bounds.Right + 16 /*0x10*/);
  ...
  private IEnumerator IntroJumpCoroutine()
  {
    ...
    if (!wasSummitJump)
    {
      player.Y = (float) (player.level.Bounds.Bottom + 16 /*0x10*/);
  ...
  private int BirdDashTutorialUpdate() => 16 /*0x10*/;
  ...
  {
    return index == 40 ? ParticleTypes.SparkyDust : ParticleTypes.Dust;
  }

...
public class OuiAssistMode : Oui
{
  ...
  {
    return selected ? (Settings.Instance.DisableFlashes || this.Scene.BetweenInterval(0.1f) ? TextMenu.HighlightColorA : TextMenu.HighlightColorB) * this.fade : Color.White * this.fade;
  }

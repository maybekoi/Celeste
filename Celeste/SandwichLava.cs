...
namespace Celeste
{
    ...
    public class SandwichLava : Entity
    {
      ...
      private float centerY => (float) this.SceneAs<Level>().Bounds.Bottom - 10f;
      ...
      public SandwichLava(float startX)
      {
        ...
        this.Collider = (Collider) new ColliderList(new Collider[2]
        {
          ...
          (Collider) new Hitbox(340f, 120f, y: -280f)
        });
        this.Visible = false;
      ...
      private void OnPlayer(Player player)
      {
        ...
        if (SaveData.Instance.Assists.Invincible)
        {
          ...
          float from = this.Y;
          float to = this.Y + (float) (num * 48 /*0x30*/);
      ...
      public void Leave()
      {
        ...
        Alarm.Set((Entity) this, 2f, (Action) (() => this.RemoveSelf()));
      }

...
namespace Celeste
{
    ...
    public class MoonCreature : Entity
    {
      ...
      {
        this.followingOffset = new Vector2((float) (Calc.Random.Choose<int>(-1, 1) * Calc.Random.Range(8, 16 /*0x10*/)), Calc.Random.Range(-20f, 0.0f));
      }
      ...
      private void GetRandomTarget()
      {
        ...
        do
        {
          ...
          this.target = this.start + Calc.AngleToVector(Calc.Random.NextFloat(6.28318548f), length);
        }

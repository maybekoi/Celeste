...
public class AreaData
{
  ...
  {
    return scene != null && scene is Level ? AreaData.Areas[(scene as Level).Session.Area.ID] : (AreaData) null;
  }

  public static AreaData Get(Session session)
  {
    return session != null ? AreaData.Areas[session.Area.ID] : (AreaData) null;
  }

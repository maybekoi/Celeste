...
namespace Celeste
{
    ...
    public class Textbox : Entity
    {
      ...
      {
        get => this.portrait == null || this.portrait.Sprite == null ? "" : this.portrait.Sprite;
      }

      public string PortraitAnimation
      {
        get => this.portrait == null || this.portrait.Sprite == null ? "" : this.portrait.Animation;
      }
            ...
            case FancyText.Portrait _:
              ...
              if (textbox.portraitExists)
              {
                if (textbox.portrait == null || next1.Sprite != textbox.portrait.Sprite)
                {
                  ...
                  textbox.portraitScale = 240f / (float) xml.AttrInt("size", 160 /*0xA0*/);
      ...
      {
        return SaveData.Instance != null && SaveData.Instance.Assists.MirrorMode ? -portrait.Side : portrait.Side;
      }

...
public class LightBeam : Entity
{
  ...
  public override void Render()
  {
    ...
    for (int index = 0; index < this.LightWidth; index += 4)
    {
      ...
      float offset = (float) Math.Sin(((double) num + (double) (index * 32 /*0x20*/)) * 0.10000000149011612 + Math.Sin((double) num * 0.05000000074505806 + (double) index * 0.10000000149011612) * 0.25) * (float) ((double) this.LightWidth / 2.0 - (double) width / 2.0);

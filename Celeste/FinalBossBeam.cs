...
public class FinalBossBeam : Entity
{
  ...
  public override void Update()
  {
    ...
    else
    {
      ...
      {
        this.beamSprite.Play("shoot");
        this.beamStartSprite.Play("shoot", true);
      }
  ...
  private void PlayerCollideCheck()
  {
    ...
    player?.Die((player.Center - this.boss.BeamOrigin).SafeNormalize());
  }

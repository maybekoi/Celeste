    ...
    public class FlingBird : Entity
    {
        ...
        private IEnumerator LeaveRoutine()
        {
            ...
            */
            ...
            flingBird.sprite.Scale.X = 1f;
            flingBird.sprite.Play("fly");
            Vector2 to = new Vector2((float)((flingBird.Scene as Level).Bounds.Right + 32 /*0x20*/), flingBird.Y);
            yield return this.MoveOnCurve(this.Position, (this.Position + to) * 0.5f - Vector2.UnitY * 12f, to);
            base.RemoveSelf();
            yield break;
        }
        ...
        private IEnumerator MoveOnCurve(Vector2 from, Vector2 anchor, Vector2 to)
        {
            ...
            float duration = curve.GetLengthParametric(32 /*0x20*/) / 500f;
            Vector2 was = from;
        ...
        {
            new SimpleCurve(a, b, anchor).Render(Color.Red, 32 /*0x20*/);
        }

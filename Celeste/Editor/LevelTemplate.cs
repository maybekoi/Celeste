...
public class LevelTemplate
{
  ...
  {
    get => new Vector2((float) Math.Min(this.Width, 4), (float) Math.Min(this.Height, 4));
  }
  ...
  public LevelTemplate(LevelData data)
  {
    ...
    foreach (EntityData entity in data.Entities)
    {
      if (entity.Name.Equals("strawberry") || entity.Name.Equals("snowberry"))
      {
        ...
        this.StrawberryMetadata.Add($"{(object) entity.Int("checkpointID")}:{(object) entity.Int("order")}");
      }

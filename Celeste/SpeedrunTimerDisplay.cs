...
public class SpeedrunTimerDisplay : Entity
{
  ...
  public override void Render()
  {
    ...
    else
    {
      ...
      string timeString1 = timeSpan1.TotalHours < 1.0 ? timeSpan1.ToString("mm\\:ss") : $"{(object) (int) timeSpan1.TotalHours}:{timeSpan1.ToString("mm\\:ss")}";
      ...
      int num = totalHours < 10 ? 64 /*0x40*/ : (totalHours < 100 ? 96 /*0x60*/ : 128 /*0x80*/);

...
namespace Celeste
{
    ...
    public class StarJumpController : Entity
    {
      ...
      public StarJumpController() => this.InitBlockFill();

      public override void Added(Scene scene)
      {
        base.Added(scene);
        this.level = this.SceneAs<Level>();
        this.minY = (float) (this.level.Bounds.Top + 80 /*0x50*/);
        this.maxY = (float) (this.level.Bounds.Top + 1800);
        this.minX = (float) (this.level.Bounds.Left + 80 /*0x50*/);
        this.maxX = (float) (this.level.Bounds.Right - 80 /*0x50*/);
      ...
      private struct Ray
      {
        ...
        public void Reset()
        {
          ...
          this.Width = (float) Calc.Random.Next(8, 80 /*0x50*/);

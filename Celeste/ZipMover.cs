...
public class ZipMover : Solid
{
  ...
  public ZipMover(Vector2 position, int width, int height, Vector2 target, ZipMover.Themes theme)
  ...
  private void ScrapeParticlesCheck(Vector2 to)
  {
    ...
    if (flag1 && !flag2)
    {
      ...
      if (num1 == -1)
        num3 = Math.Max(16 /*0x10*/, (int) this.Height - 16 /*0x10*/);
    ...
    else
    {
      ...
      if (num4 == -1)
        num6 = Math.Max(16 /*0x10*/, (int) this.Width - 16 /*0x10*/);

...
namespace Celeste
{
    ...
    public class ViewportAdjustmentUI : Entity
    {
      ...
      public override void Render()
      {
        ...
        Draw.Rect(0.0f, 16f, 16f, (float) (Engine.Height - 32 /*0x20*/), color2);
        Draw.Rect((float) (Engine.Width - 16 /*0x10*/), 16f, 16f, (float) (Engine.Height - 32 /*0x20*/), color2);
        Draw.Rect(0.0f, (float) (Engine.Height - 16 /*0x10*/), (float) Engine.Width, 16f, color2);

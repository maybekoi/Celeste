...
public static class Input
{
  ...
  public static bool GuiInputController(Celeste.Input.PrefixMode mode = Celeste.Input.PrefixMode.Latest)
  {
    return !Celeste.Input.GuiInputPrefix(mode).Equals("keyboard");
  }

  public static MTexture GuiButton(VirtualButton button, Celeste.Input.PrefixMode mode = Celeste.Input.PrefixMode.Latest, string fallback = "controls/keyboard/oemquestion")
  {
  ...
  public static MTexture GuiSingleButton(Buttons button, Celeste.Input.PrefixMode mode = Celeste.Input.PrefixMode.Latest, string fallback = "controls/keyboard/oemquestion")
  {
  ...
  {
    return Celeste.Input.GuiTexture("directions", $"{(object) Math.Sign(direction.X)}x{(object) Math.Sign(direction.Y)}");
  }

...
public class Lookout : Entity
{
  ...
  {
    this.Depth = -8500;
    this.Add((Component) (this.talk = new TalkComponent(new Rectangle(-24, -8, 48 /*0x30*/, 8), new Vector2(-0.5f, -20f), new Action<Player>(this.Interact))));
    ...
    VertexLight vertexLight = new VertexLight(new Vector2(-1f, -11f), Color.White, 0.8f, 16 /*0x10*/, 24);
...
label_56:
  ...
  private class Hud : Entity
  {
    ...
    private float down;
    private Vector2 aim;
    private MTexture halfDot = GFX.Gui["dot"].GetSubtexture(0, 0, 64 /*0x40*/, 32 /*0x20*/);
    ...
    public override void Render()
    {
      ...
      else
      {
        if (!this.TrackMode)
          return;
        int num4 = 1080 - y1 * 2 - 128 /*0x80*/ - 64 /*0x40*/;
        int x4 = 1920 - x1 - 64 /*0x40*/;

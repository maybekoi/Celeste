...
public class Bridge : Entity
{
    ...
    : base(position)
  {
    ...
    this.tileSizes.Add(new Rectangle(0, 0, 16 /*0x10*/, 52));
    this.tileSizes.Add(new Rectangle(16 /*0x10*/, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(24, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(32 /*0x20*/, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(40, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(48 /*0x30*/, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(56, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(64 /*0x40*/, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(72, 0, 8, 52));
    this.tileSizes.Add(new Rectangle(80 /*0x50*/, 0, 16 /*0x10*/, 52));
    this.tileSizes.Add(new Rectangle(96 /*0x60*/, 0, 8, 52));

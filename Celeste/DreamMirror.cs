...
namespace Celeste
{
    ...
    public class DreamMirror : Entity
    {
      ...
      public override void Added(Scene scene)
      {
        ...
        this.Collider = (Collider) (this.hitbox = new Hitbox((float) ((int) this.frame.Width - 16 /*0x10*/), (float) ((int) this.frame.Height + 32 /*0x20*/), (float) (-(int) this.frame.Width / 2 + 8), (float) (-(int) this.frame.Height - 32 /*0x20*/)));
      }
      ...
      public IEnumerator BreakRoutine(int direction)
      {
        ...
        {
          dreamMirror.reflection.X += (float) (direction * 32 /*0x20*/) * Engine.DeltaTime;
          yield return (object) null;
        }

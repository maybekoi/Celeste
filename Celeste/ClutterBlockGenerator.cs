...
public static class ClutterBlockGenerator
{
  ...
  public static void Generate()
  {
    ...
    for (int index4 = 0; index4 < ClutterBlockGenerator.columns; ++index4)
    {
      ...
      {
        ClutterBlockGenerator.Tile tile1 = ClutterBlockGenerator.tiles[index4, index5];
        if (tile1.Block != null)
        {
          ...
          {
            ClutterBlockGenerator.Tile tile2 = ClutterBlockGenerator.tiles[index4, index5 + 1];
            if (tile2.Wall)
  ...
  private struct Tile
  {
    ...
    public bool Empty => !this.Wall && this.Color == -1;
  }

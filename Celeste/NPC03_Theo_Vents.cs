...
public class NPC03_Theo_Vents : NPC
{
  ...
  private IEnumerator Appear()
  {
    ...
    npC03TheoVents.Visible = true;
    npC03TheoVents.Add((Component) (npC03TheoVents.Talker = new TalkComponent(new Rectangle(-16, 0, 32 /*0x20*/, 100), new Vector2(0.0f, -8f), new Action<Player>(npC03TheoVents.OnTalk))));
  }

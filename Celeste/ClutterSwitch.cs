...
namespace Celeste
{
    ...
    public class ClutterSwitch : Solid
    {
        ...
        private const int UnpressedLightRadius = 32 /*0x20*/;
        private const int PressedLightRadius = 24;
        private const int BrightLightRadius = 64 /*0x40*/;
          ...
          : base(position, 32f, 16f, true)
        {
            ...
            this.Add((Component)(this.vertexLight = new VertexLight(new Vector2(this.CenterX - this.X, -1f), Color.Aqua, 1f, 32 /*0x20*/, 64 /*0x40*/)));
        }

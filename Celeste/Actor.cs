...
public class Actor : Entity
{
  ...
  {
    return !this.IgnoreJumpThrus && this.CollideCheckOutside((Entity) jumpThru, this.Position + Vector2.UnitY);
  }
  ...
  {
    this.MoveH(toX - this.ExactPosition.X, onCollide);
  }

  public void MoveToY(float toY, Collision onCollide = null)
  {
    this.MoveV(toY - this.ExactPosition.Y, onCollide);
  }

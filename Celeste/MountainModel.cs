...
public class MountainModel : IDisposable
{
  ...
  private VertexPositionColorTexture[] billboardInfo = new VertexPositionColorTexture[2048 /*0x0800*/];
  private Texture2D[] billboardTextures = new Texture2D[512 /*0x0200*/];
  private Ring fog;
  private Ring fog2;
  ...
  public MountainModel()
  {
    ...
    this.starstream0 = new Ring(5f, -8f, 18.5f, 0.2f, 80 /*0x50*/, Color.Black, MTN.MountainStarStream);
    this.starstream1 = new Ring(4f, -6f, 18f, 1f, 80 /*0x50*/, Calc.HexToColor("9228e2") * 0.5f, MTN.MountainStarStream);
    this.starstream2 = new Ring(3f, -4f, 17.9f, 1.4f, 80 /*0x50*/, Calc.HexToColor("30ffff") * 0.5f, MTN.MountainStarStream);
  ...
  public void Update()
  {
    ...
    this.starfog.Rotate((float) (-(double) Engine.DeltaTime * 0.0099999997764825821));
    this.fog.Rotate((float) (-(double) Engine.DeltaTime * 0.0099999997764825821));
    ...
    this.fog2.Rotate((float) (-(double) Engine.DeltaTime * 0.0099999997764825821));
  ...
  public void BeforeRender(Scene scene)
  {
    ...
    {
      Matrix matrix3 = Matrix.CreateTranslation(0.0f, (float) (5.0 - (double) this.Camera.Position.Y * 1.1000000238418579), 0.0f) * Matrix.CreateFromQuaternion(quaternion) * perspectiveFieldOfView;
      if (this.currState == this.nextState)
      {

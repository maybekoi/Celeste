...
public class Level : Scene, IOverlayHandler
{
  ...
  {
    get => this.Session.Area.Mode != AreaMode.Normal || !this.Session.Cassette;
  }
  ...
  private IEnumerator TransitionRoutine(LevelData next, Vector2 direction)
  {
    ...
    bounds.Inflate(16 /*0x10*/, 16 /*0x10*/);
    ...
    else
    {
      ...
      if (num1 != 10)
      {
        if ((HandleBase) Level.AssistSpeedSnapshot == (HandleBase) null || Level.AssistSpeedSnapshotValue != num1)
        {
          ...
          else if (Level.AssistSpeedSnapshotValue <= 16 /*0x10*/)
  ...
  private void VariantMode(int returnIndex, bool minimal)
  {
    ...
    TextMenu.Slider slider = speed = new TextMenu.Slider(label1, (Func<int, string>) (i => (i * 10).ToString() + "%"), 5, 16 /*0x10*/, gameSpeed);

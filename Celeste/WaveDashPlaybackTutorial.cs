...
public class WaveDashPlaybackTutorial
{
  ...
  {
    TrailManager.Add(this.Playback.Position, (Monocle.Image) this.Playback.Sprite, this.Playback.Hair, this.Playback.Sprite.Scale, Player.UsedHairColor, 0).Tag = this.tag;
  }
}

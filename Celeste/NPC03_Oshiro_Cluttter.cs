...
public class NPC03_Oshiro_Cluttter : NPC
{
    ...
    : base(data.Position + offset)
  {
    ...
    this.Add((Component) (this.Talker = new TalkComponent(new Rectangle(-24, -8, 48 /*0x30*/, 8), new Vector2(0.0f, -24f), new Action<Player>(this.OnTalk))));
  ...
  public Vector2 ZoomPoint
  {
    get
    {
      return this.sectionsComplete < 2 ? this.Position + new Vector2(0.0f, -30f) - this.Level.Camera.Position : this.Position + new Vector2(0.0f, -15f) - this.Level.Camera.Position;
    }
  }

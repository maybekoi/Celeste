...
{
  private VertexPositionColor[] vertexBufferLeft = new VertexPositionColor[192 /*0xC0*/];
  private VertexPositionColor[] vertexBufferRight = new VertexPositionColor[192 /*0xC0*/];

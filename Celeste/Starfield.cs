...
{
  public const int StepSize = 32 /*0x20*/;
  ...
  public Starfield.Star[] Stars = new Starfield.Star[128 /*0x80*/];
  ...
  {
    Vector2 vector2_1 = new Vector2((float) (star.NodeIndex * 32 /*0x20*/), this.YNodes[star.NodeIndex]);
    Vector2 vector2_2 = new Vector2((float) ((star.NodeIndex + 1) * 32 /*0x20*/), this.YNodes[star.NodeIndex + 1]);

...
public class CS03_OshiroMasterSuite : CutsceneEntity
{
  ...
  private IEnumerator Cutscene(Level level)
  {
    ...
    yield return (object) oshiroMasterSuite.evil.FloatTo(new Vector2(oshiroMasterSuite.evil.X, (float) (level.Bounds.Top - 32 /*0x20*/)));
  ...
  private IEnumerator Wander()
  {
    ...
    yield return (object) oshiroMasterSuite.player.DummyWalkToExact((int) oshiroMasterSuite.oshiro.X + 48 /*0x30*/);
    yield return (object) 1f;
    oshiroMasterSuite.player.Facing = Facings.Left;
    yield return (object) 0.2f;
    yield return (object) oshiroMasterSuite.player.DummyWalkToExact((int) oshiroMasterSuite.oshiro.X - 32 /*0x20*/);
    yield return (object) 0.1f;
  ...
  {
    yield return (object) this.player.DummyWalkToExact((int) this.oshiro.X - 16 /*0x10*/);
  }
  ...
  private IEnumerator SuiteShadowCeiling()
  {
    ...
    yield return (object) oshiroMasterSuite.evil.FloatTo(new Vector2((float) (oshiroMasterSuite.Level.Bounds.Left + 96 /*0x60*/), oshiroMasterSuite.evil.Y - 16f), new int?(1));
    oshiroMasterSuite.player.Facing = Facings.Left;

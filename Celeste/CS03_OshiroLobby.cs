...
namespace Celeste
{
    ...
    public class CS03_OshiroLobby : CutsceneEntity
    {
      ...
      private IEnumerator Cutscene(Level level)
      {
        ...
        VertexLight light = new VertexLight(new Vector2(0.0f, -8f), Color.White, 1f, 32 /*0x20*/, 64 /*0x40*/);
        ...
        foreach (MrOshiroDoor mrOshiroDoor in cs03OshiroLobby.Scene.Entities.FindAll<MrOshiroDoor>())
          mrOshiroDoor.Open();
        cs03OshiroLobby.oshiro.MoveToAndRemove(new Vector2((float) (level.Bounds.Right + 64 /*0x40*/), cs03OshiroLobby.oshiro.Y));

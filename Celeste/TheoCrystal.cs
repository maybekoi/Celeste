...
public class TheoCrystal : Actor
{
    ...
    : base(position)
  {
    ...
    this.Add((Component) new VertexLight(this.Collider.Center, Color.White, 1f, 32 /*0x20*/, 64 /*0x40*/));
    ...
    else
    {
      ...
      else
      {
        ...
        if (templeGate != null && entity != null)
        {
          ...
          this.MoveH((float) (Math.Sign(entity.X - this.X) * 32 /*0x20*/) * Engine.DeltaTime);
  ...
  public IEnumerator Shatter()
  {
    ...
    VertexLight light = new VertexLight(Color.AliceBlue, 0.0f, 64 /*0x40*/, 200);

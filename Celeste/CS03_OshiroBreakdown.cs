...
public class CS03_OshiroBreakdown : CutsceneEntity
{
  ...
  private IEnumerator Cutscene(Level level)
  {
    ...
    cs03OshiroBreakdown.Add((Component) new Coroutine(cs03OshiroBreakdown.oshiro.MoveTo(new Vector2((float) (level.Bounds.Left - 64 /*0x40*/), cs03OshiroBreakdown.oshiro.Y))));

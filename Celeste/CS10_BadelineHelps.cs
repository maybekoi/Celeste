...
namespace Celeste {
    ...
    public class CS10_BadelineHelps : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return (object)Textbox.Say("CH9_HELPING_HAND", new Func<IEnumerator>(cs10BadelineHelps.MadelineFacesAway), new Func<IEnumerator>(cs10BadelineHelps.MadelineFacesBadeline), new Func<IEnumerator>(cs10BadelineHelps.MadelineStepsForwards));
        ...
        private IEnumerator BadelineAppears()
        {
            ...
            cs10BadelineHelps.Level.Add((Entity)(cs10BadelineHelps.badeline = new BadelineDummy(cs10BadelineHelps.player.Center)));
            ...
            yield return (object)cs10BadelineHelps.badeline.FloatTo(cs10BadelineHelps.player.Center + new Vector2(18f, -10f), new int?(-1), false);
        ...
        private IEnumerator MadelineFacesAway()
        {
            ...
            */
            CS10_BadelineHelps cs10BadelineHelps = this;
            cs10BadelineHelps.Level.NextColorGrade("feelingdown", 0.1f);
            yield return cs10BadelineHelps.player.DummyWalkTo(cs10BadelineHelps.player.X - 16f, false, 1f, false);
            yield break;
        }

    ...
    public class NPC : Entity
    {
        ...
        public override void Update()
        {
            ...
            if (this.UpdateLight && this.Light != null)
            {
                ...
                this.Light.Alpha = Calc.Approach(this.Light.Alpha, (double)this.X <= (double)(bounds.Left - 16 /*0x10*/) || (double)this.Y <= (double)(bounds.Top - 16 /*0x10*/) || (double)this.X >= (double)(bounds.Right + 16 /*0x10*/) || (double)this.Y >= (double)(bounds.Bottom + 16 /*0x10*/) || this.Level.Transitioning ? 0.0f : 1f, Engine.DeltaTime * 2f);
            }
        ...
        public IEnumerator PlayerApproach(Player player, bool turnToFace = true, float? spacing = null, int? side = null)
        {
            ...
            player.Facing = (Facings)(-(int)side.Value);
        ...
        {
            this.Add((Component)new Coroutine(this.MoveTo(target, removeAtEnd: true)));
        }
    }
}
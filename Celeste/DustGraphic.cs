...
public class DustGraphic : Component
{
    ...
    : base(true, true)
  {
    ...
    this.eyeTextureIndex = Calc.Random.Next(128 /*0x80*/);
    this.eyesExist = true;
    if (autoControlEyes)
    {
  ...
  private void AddNode(Vector2 angle, bool enabled)
  {
    ...
    if (this.autoExpandDust)
    {
      ...
      if (this.Scene.CollideCheck<Solid>(new Rectangle((int) ((double) this.Entity.X - 4.0 + (double) (num1 * 16 /*0x10*/)), (int) ((double) this.Entity.Y - 4.0 + (double) (num2 * 4)), 8, 8)) || this.Scene.CollideCheck<DustStaticSpinner>(new Rectangle((int) ((double) this.Entity.X - 4.0 + (double) (num1 * 16 /*0x10*/)), (int) ((double) this.Entity.Y - 4.0 + (double) (num2 * 4)), 8, 8)))
        vector2.X = 5f;
      if (this.Scene.CollideCheck<Solid>(new Rectangle((int) ((double) this.Entity.X - 4.0 + (double) (num1 * 4)), (int) ((double) this.Entity.Y - 4.0 + (double) (num2 * 16 /*0x10*/)), 8, 8)) || this.Scene.CollideCheck<DustStaticSpinner>(new Rectangle((int) ((double) this.Entity.X - 4.0 + (double) (num1 * 4)), (int) ((double) this.Entity.Y - 4.0 + (double) (num2 * 16 /*0x10*/)), 8, 8)))
        vector2.Y = 5f;

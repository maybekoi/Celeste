...
namespace Celeste
{
    ...
    public class NPC03_Oshiro_Lobby : NPC
    {
        ...
        : base(position)
      {
        ...
        this.Add((Component) (this.Talker = new TalkComponent(new Rectangle(-30, -16, 42, 32 /*0x20*/), new Vector2(-12f, -24f), new Action<Player>(this.OnTalk), new TalkComponent.HoverDisplay()
        {
          Texture = mtexture,

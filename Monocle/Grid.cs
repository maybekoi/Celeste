...
public class Grid : Collider
{
  ...
  {
    return (double) point.X >= (double) this.AbsoluteLeft && (double) point.Y >= (double) this.AbsoluteTop && (double) point.X < (double) this.AbsoluteRight && (double) point.Y < (double) this.AbsoluteBottom && this.Data[(int) (((double) point.X - (double) this.AbsoluteLeft) / (double) this.CellWidth), (int) (((double) point.Y - (double) this.AbsoluteTop) / (double) this.CellHeight)];
  }

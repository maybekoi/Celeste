...
namespace Monocle
{
    ...
    public class Engine : Game
    {
      ...
      {
        get => Path.Combine(Engine.AssemblyDirectory, Engine.Instance.Content.RootDirectory);
      }
        ...
        bool vsync)
      {
        ...
        GCSettings.LatencyMode = GCLatencyMode.Interactive | GCLatencyMode.LowLatency;
      }

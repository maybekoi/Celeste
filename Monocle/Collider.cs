...
public abstract class Collider
{
  ...
  {
    get => this.Entity != null ? this.Entity.Position + this.Position : this.Position;
  }

  public float AbsoluteX
  {
    get => this.Entity != null ? this.Entity.Position.X + this.Position.X : this.Position.X;
  }

  public float AbsoluteY
  {
    get => this.Entity != null ? this.Entity.Position.Y + this.Position.Y : this.Position.Y;
  }
  ...
  {
    get => this.Entity != null ? this.Bottom + this.Entity.Position.Y : this.Bottom;
  }
  ...
  {
    get => this.Entity != null ? this.Right + this.Entity.Position.X : this.Right;
  }
